...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
      ...
      yearly_data = data[(data["Year" == input_year]) & (data['Recession'] == 0)]

      #plot 1 Yearly Automobile sales using line chart for the whole period.
      yas=yearly_data.groupby('Year')['Automobile_Sales'].mean().reset_index()
      Y_chart1 = dcc.Graph(figure=px.line(yas,x='Year',y='Automobile_Sales',title="Average Yearly Automobile Sales fluctuation over Non Recession Period"))
      
      # Plot 2 Total Monthly Automobile sales using line chart.
       
      Y_chart2 = dcc.Graph(figure=px.line(yearly_data,x='Month',y='Automobile_Sales',title="Average Monthly Automobile Sales fluctuation over Non Recession Period"))
      ...
      Y_chart4  = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type',title="Expenditure By Vehicle Type" ))
